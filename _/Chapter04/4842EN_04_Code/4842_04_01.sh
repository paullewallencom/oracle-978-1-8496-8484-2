...
#
#************************************************************************
# MODULE NAME:          4842_04_01.sh
# ORIGINAL AUTHOR:      Andy Penver
# DATE:                 15-SEP-2011
# DESCRIPTION:
#
# Installation Script for Chapter 4 to be installed within APPS database schema
#
# PARAMETERS:
#
...
l_db_pkg_list="XXHR_GEN_VALID_PKG.pks \
