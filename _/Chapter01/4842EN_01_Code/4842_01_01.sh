...
#
#************************************************************************
# MODULE NAME:          4842_01_01.sh
# ORIGINAL AUTHOR:      Andy Penver
# DATE:                 15-SEP-2011
# DESCRIPTION:
#
# Installation Script for Chapter 1 to be installed within APPS database schema
#
# PARAMETERS:
#
...
l_db_object_list="xxhr_xml_batch_seq.sql \
                  xxhr_xml_batch_seq_syn.sql"

l_trigger_list=""

l_db_pkg_list="XXHR_EMAIL_FILE_PKG.pks \
			   XXHR_EMAIL_FILE_PKG.pkb"
