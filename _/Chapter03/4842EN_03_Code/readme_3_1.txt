Installation instructions for Database objects for Chapter 3
---------------------------------------------------------------

Create a local directory c:\packt\scripts\ch3 where the scripts are downloaded to
...
5. FTP the files from c:\packt\scripts\ch3 to $XXHR_TOP/install/ch3
...
6. Change the permissions of the script with the following command, 
	...
	chmod 775 4842_03_01.sh

7. Run the following script to create all of the objects by issuing the following command 

	./4842_03_01.sh apps/<apps pwd>

WinSCP
------

8. Check the XXHR_4842_03_01.log file for errors.