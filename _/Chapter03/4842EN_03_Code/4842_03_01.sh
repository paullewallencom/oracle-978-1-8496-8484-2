...
#
#************************************************************************
# MODULE NAME:          4842_03_01.sh
# ORIGINAL AUTHOR:      Andy Penver
# DATE:                 15-SEP-2011
# DESCRIPTION:
#
# Installation Script for Chapter 3 to be installed within APPS database schema
#
# PARAMETERS:
#
...
l_db_object_list="XXHR_PER_MEDIA_SUBS.sql \
...
l_db_pkg_list="XXHR_PER_MEDIA_SUBS_PVT.pks \
		 XXHR_PER_MEDIA_SUBS_PVT.pkb"
