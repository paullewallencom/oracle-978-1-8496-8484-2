...
#
#************************************************************************
# MODULE NAME:          4842_06_01.sh
# ORIGINAL AUTHOR:      Andy Penver
# DATE:                 15-SEP-2011
# DESCRIPTION:
#
# Installation Script for Chapter 6 to be installed within APPS database schema
#
# PARAMETERS:
#
...
l_control_file_list="$FND_TOP/patch/115/import/aflvmlu.lct LU_XXHR_SOCIETY_LOV.ldt \
                     $FND_TOP/patch/115/import/afffload.lct DFF_XXHR_PER_SOCIETIES.ldt \
					 $FND_TOP/patch/115/import/afcpprog.lct CP_XXHR_FIRST_CONC_PROG.ldt \
					 $FND_TOP/patch/115/import/afcprset.lct RS_XXHR20001.ldt \
					 $FND_TOP/patch/115/import/afcprset.lct RSL_XXHR20001.ldt \
					 $FND_TOP/patch/115/import/afscprof.lct PROF_XXHR_WRITE_LOGFILE.ldt \
					 $FND_TOP/patch/115/import/afsload.lct FORM_XXHRSOCC.ldt \
					 $FND_TOP/patch/115/import/afsload.lct FUNC_XXHR_EMP_SOCIETY.ldt \
					 $FND_TOP/patch/115/import/afsload.lct MENU_XXHR_TEST_MENU.ldt \
					 $FND_TOP/patch/115/import/afcpreqg.lct RG_XXHR_REQUEST_GROUP.ldt \
					 $FND_TOP/patch/115/import/afscursp.lct RESP_XXHR_ADMIN.ldt \
					 $FND_TOP/patch/115/import/affrmcus.lct PZ_PERWSHRG.ldt \
					 $FND_TOP/patch/115/import/afmdmsg.lct MESG_XXHR_ON_HOLD_WARNING.ldt "
...
l_db_object_list="XXHR_PER_SOCIETIES.sql \
				  ...
				  XXHR_PER_MEDIA_SUBS.sql \
                  XXHR_PER_MEDIA_SUBS_SYN.sql \
				  XXHR_PER_MEDIA_SUBS_V.sql \
				  XXHR_PER_MEDIA_SUBS_SEQ.sql \
				  XXHR_PER_MEDIA_SUBS_SEQ_SYN.sql \
				  XXHR_XML_WF_IN.sql \
				  XXHR_XML_WF_IN_SYN.sql \
				  XXHR_EVENT_ENQUEUE_S.sql"

l_trigger_list=""

l_db_pkg_list="XXHR_PER_SOCIETIES_PVT.pks \
			   XXHR_PER_SOCIETIES_PVT.pkb \
			   XXHR_GEN_VALID_PKG.pks \
               XXHR_GEN_VALID_PKG.pkb \
			   XXHR_ABSENCE_IN_WF_PKG.pks \
               XXHR_ABSENCE_IN_WF_PKG.pkb"

l_wf_list="XXHRIABS.wft"
