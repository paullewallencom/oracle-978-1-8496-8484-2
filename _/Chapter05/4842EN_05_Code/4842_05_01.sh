...
#
#************************************************************************
# MODULE NAME:          4842_05_01.sh
# ORIGINAL AUTHOR:      Andy Penver
# DATE:                 15-SEP-2011
# DESCRIPTION:
#
# Installation Script for Chapter 5 to be installed within APPS database schema
#
# PARAMETERS:
#
...
l_db_object_list="XXHR_XML_WF_IN.sql \
				  XXHR_XML_WF_IN_SYN.sql \
				  XXHR_EVENT_ENQUEUE_S.sql"

l_trigger_list=""

l_db_pkg_list="XXHR_ABSENCE_IN_WF_PKG.pks \
